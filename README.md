...
## LearnWords Privacy Policy

Esta página tiene como objetivo informar a los usuarios sobre nuestras políticas relacionadas con la recopilación, el uso y la divulgación de información personal cuando deciden utilizar nuestro servicio.

Si decides utilizar nuestro servicio, aceptas la recopilación y el uso de información en relación con esta política. La información personal que recopilamos se utilizará para proporcionar y mejorar el servicio. No utilizaremos ni compartiremos tu información con terceros, excepto como se describe en esta Política de Privacidad.

Los términos utilizados en esta Política de Privacidad tienen los mismos significados que en nuestros Términos y Condiciones, que están accesibles en LearnWords, a menos que se defina lo contrario en esta Política de Privacidad.

### Recopilación y Uso de Información

Para ofrecerte una experiencia mejorada mientras utilizas nuestro servicio, podemos solicitarte que nos proporciones cierta información personal identificable, como tu ID publicitario, que es un número generado al azar que nos permite personalizar anuncios. Puedes desactivar esta función desde la configuración de Google en tu dispositivo. La información que solicitamos será retenida por nosotros y utilizada como se describe en esta política de privacidad.

La aplicación utiliza servicios de terceros que pueden recopilar información utilizada para identificarte, tales como:
...
Queremos informarte que cada vez que utilizas nuestro servicio y en caso de un error en la aplicación, recopilamos datos e información (a través de productos de terceros) en tu dispositivo denominados **Datos de Registro**. Estos Datos de Registro pueden incluir información como la dirección IP de tu dispositivo, el nombre del dispositivo, la versión del sistema operativo, la configuración de la aplicación, la fecha y hora de uso del servicio y otras estadísticas relacionadas.

### Cookies

Las cookies son pequeños archivos de datos que se utilizan comúnmente como identificadores únicos y anónimos. Se envían a tu navegador desde los sitios web que visitas y se almacenan en la memoria interna de tu dispositivo.

Este servicio no utiliza explícitamente **cookies**. Sin embargo, algunos de nuestros proveedores de servicios de terceros pueden utilizar cookies para recopilar información y mejorar su servicio. Puedes optar por aceptar o rechazar estas cookies. Si eliges rechazarlas, algunas partes del servicio podrían no funcionar correctamente.

### Proveedores de Servicios

Podemos emplear empresas e individuos de terceros por las siguientes razones:

1. Facilitar nuestro servicio.
2. Proporcionar el servicio en nuestro nombre.
3. Realizar servicios relacionados con el servicio.
4. Ayudarnos a analizar cómo se utiliza el servicio.

Queremos informarte que estos terceros tienen acceso a tu información personal únicamente para realizar las tareas asignadas en nuestro nombre, pero están obligados a no divulgar ni utilizar esta información para ningún otro propósito.

### Seguridad

Valoramos tu confianza al proporcionarnos tu información personal, por lo que nos esforzamos por utilizar medios comercialmente aceptables para protegerla. Sin embargo, recuerda que ningún método de transmisión a través de internet o de almacenamiento electrónico es 100% seguro, y no podemos garantizar la seguridad absoluta de tu información.

### Enlaces a Otros Sitios

Este servicio puede contener enlaces a otros sitios. Si haces clic en un enlace de un tercero, serás dirigido a ese sitio. Ten en cuenta que estos sitios externos no son operados por nosotros. Por lo tanto, te recomendamos revisar la política de privacidad de esos sitios web. No tenemos control sobre, ni asumimos responsabilidad por el contenido, las políticas de privacidad o las prácticas de esos sitios web o servicios de terceros.

### Privacidad de los Niños

Este servicio no está dirigido a personas menores de 13 años. No recopilamos conscientemente información personal identificable de niños menores de 13 años.

© [2025] LearnWords. Todos los derechos reservados.

---

Este es un formato básico que puedes ajustar según las características específicas de tu app, como si incluye compras dentro de la app, o interacciones adicionales con el usuario. ¿Hay algún aspecto particular que te gustaría añadir o modificar?
